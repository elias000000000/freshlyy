      ...
      <div style={{padding:"14px 20px 0"}}>
        <div style={{display:"flex",gap:8,marginBottom:11}}>
          ...
          <button onClick={()=>setModal({type:"receipt"})} className="tap"
            style={{background:C.green,border:"none",borderRadius:12,padding:"0 14px",cursor:"pointer",display:"flex",alignItems:"center",gap:6,boxShadow:`0 2px 8px ${C.green}30`}}>
